...
| PAYMENT_GATEWAY_TARGET_ORIGINS              | Base URLs where your frontend will be accessible                                       |     Used for Credit Card payment method. Comma separated value without any spaces                                                                                                               |
