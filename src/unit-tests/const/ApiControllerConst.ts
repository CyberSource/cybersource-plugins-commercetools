 ...
 const payerAuthenticationPaymentObj = {
 ...
 const payerAuthEnrollPaymentObj = {
  id: '22578389-5add-40e4-8a05-f9b2959218bf',
  version: 16,
 ...
 let payerAuthSetupResponsePaymentObject: any = {
 ...
 const paymentId = '26d5cd67-1db2-4907-b631-486b44fc0c3a';

 const customerUpdateFlexKeysPaymentObj = {
 ...
 const customerUpdateAddCardPaymentObject : any = {
 ...
 const captureId = 'd4d1ab02-141c-42f6-bbe6-13180920623d';
 const captureAmount = 45;

 const refundAmount = 12;
 const refundId = 'd4d1ab02-141c-42f6-bbe6-13180920623d';

 const authereversalId = '651f2dfe-c6c5-44f4-8321-c21b461175e5';
