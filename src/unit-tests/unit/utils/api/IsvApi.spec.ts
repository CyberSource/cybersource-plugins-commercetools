...
import cybersourceApi from '../../../../utils/api/isvApi';
import CybersourceApiConst from '../../../const/CybersourceApiConst';
...
test.serial('Test get subscription details api function', async (t) => {
  ...
  let callbackPromise = await new Promise((resolve, reject) => {
    cybersourceApi.getSubscriptionDetails(apiClient, CybersourceApiConst.configObject, CybersourceApiConst.requestObject, (_error: any, data: any, response: any) => {
      if (data) {
