...
import com.cybersource.commercetools.sync.TransactionSynchronizer;
import com.cybersource.commercetools.sync.commercetools.AddTransactionMapper;
...
import com.cybersource.commercetools.sync.commercetools.TransactionTypeMapper;
...
public class ApplicationConfiguration {
  ...
  public ApiClient cybersourceClient(CsClientConfigurationProperties appConfig)
    ...
    var apiClient = new ApiClient(new MerchantConfig(properties));
