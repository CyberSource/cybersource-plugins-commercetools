...
public class PaymentCustomFieldConstants {
  ...
  public static final String TOKEN_ALIAS = "cs_tokenAlias";
  public static final String SAVED_TOKEN = "cs_savedToken";
  public static final String TOKEN_VERIFICATION_CONTEXT = "cs_tokenVerificationContext";
  ...
  public static final String PRODUCT_CODE = "cs_productCode";
  public static final String PRODUCT_RISK = "cs_productRisk";
}
