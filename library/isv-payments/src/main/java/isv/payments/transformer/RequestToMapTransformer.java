...
/***
 * Transforms a PaymentServiceRequest object to the Map structure required to use the Simple Order SDK
 */
public class RequestToMapTransformer {
  ...
  public Map<String, String> transform(PaymentServiceRequest request) {
