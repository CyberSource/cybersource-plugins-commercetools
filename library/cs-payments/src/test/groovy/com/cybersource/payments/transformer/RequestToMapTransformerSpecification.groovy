package com.cybersource.payments.transformer

import com.cybersource.payments.model.CybersourceRequest
import com.cybersource.payments.model.fields.AbstractFieldGroup
...
class RequestToMapTransformerSpecification extends Specification {
    ...
    def 'should transform field groups into a map with correct prefixes and including extra fields'() {
        ...
        def request = new CybersourceRequest([authFields, billToFields, captureServiceFields])
    ...
    def 'should skip null or empty fields'() {
        ...
        def request = new CybersourceRequest([baseFieldGroup])
    ...
    def 'Should skip over any inaccessible fields without errors'() {
        ...
        def request = new CybersourceRequest([authFields, new BadFieldGroup()])
    ...
    def 'Should correctly transform non-string values to string values'() {
        given:
        def request = new CybersourceRequest([new NotStringGroup()])
