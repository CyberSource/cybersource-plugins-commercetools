...
class DecisionManagerDecisionSynchronizerSpecification extends Specification {
    ...
    def setup() {
        ...
        testObj = new DecisionManagerDecisionSynchronizer(csTransactionSearchServiceMock, ctClientMock, ctPaymentSearchServiceMock, 'someOrgId')
    }
    ...
    def 'synchronize conversions with new decision as ACCEPT on the commerce tools payment with pending auth transaction'() {
        ...
        1 * csTransactionSearchServiceMock.conversionDetailsGet200Response(_ as DateTime, _ as DateTime, merchantId) >> reportingV3ConversionDetailsGet200Response
    ...
    def 'Should handle the validation errors from CS'() {
        given: 'a start date'
        ...
        then:
        1 * csTransactionSearchServiceMock.conversionDetailsGet200Response(_, _, _) >> null
