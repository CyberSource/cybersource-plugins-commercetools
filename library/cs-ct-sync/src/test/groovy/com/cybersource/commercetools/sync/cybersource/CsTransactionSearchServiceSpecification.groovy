package com.cybersource.commercetools.sync.cybersource
...
import com.cybersource.commercetools.sync.cybersource.request.CsTransactionSearchPagination
import org.joda.time.DateTime
import spock.lang.Specification

class CsTransactionSearchServiceSpecification extends Specification {
    ...
    def testObj = new CsTransactionSearchService(searchTransactionApiMock, conversionDetailsApiClientMock)

    def 'should return all results for a paginated search'() {
        given:
        def pagedSearch = Mock(CsTransactionSearchPagination)
    ...
    def 'should handle no result'() {
        given:
        def pagedSearchMock = Mock(CsTransactionSearchPagination)
