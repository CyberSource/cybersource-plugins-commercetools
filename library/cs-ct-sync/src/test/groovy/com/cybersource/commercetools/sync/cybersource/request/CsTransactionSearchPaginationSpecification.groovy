package com.cybersource.commercetools.sync.cybersource.request

import Model.CreateSearchRequest
import spock.lang.Specification

class CsTransactionSearchPaginationSpecification extends Specification {

    def transactionSearchMock = Mock(CsTransactionSearchImpl)
    ...
    def 'should correctly get next requests'() {
        when:
        def testObj = new CsTransactionSearchPagination(transactionSearchMock)
