package com.cybersource.commercetools.api.extension.validation;
...
public abstract class InputValidator<T> {
    ...
    protected void validateRequiredField(List<ExtensionError> errors, Object field, String fieldName) {
        if (field == null) {
            ...
            errors.add(new ExtensionError(ErrorCode.REQUIRED_FIELD_MISSING, String.format("%s is required", fieldName), extraInfo));
        }
    }
