...
import isv.commercetools.mapping.constants.EnrolmentValidateDataConstants;
import isv.commercetools.mapping.transformer.response.ResponseTransformer;
import isv.commercetools.mapping.util.MapUtil;
...
/**
 * Transforms Payer Authentication Validation responses from payment service into Commercetools API Extension UpdateActions.
 */
public class PayerAuthValidateResponseTransformer implements ResponseTransformer {
    ...
    public List<UpdateAction> transform(Map<String, String> paymentServiceResponse, Transaction authTransaction) {
        ...
        var responseValuesMatchingPrefix = findMatchesAndStripPrefix(paymentServiceResponse);
    ...
    private Map<String, String> findMatchesAndStripPrefix(Map<String, String> paymentServiceResponse) {
        return paymentServiceResponse.entrySet().stream()
