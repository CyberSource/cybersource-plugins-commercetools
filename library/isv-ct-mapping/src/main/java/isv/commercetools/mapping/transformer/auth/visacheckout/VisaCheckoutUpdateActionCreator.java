 ...
 * The field groups provided should be built from a payment service response to the 'getVisaCheckoutDataService'
 */
public class VisaCheckoutUpdateActionCreator {

    private final PaymentServiceResponseAddressMapper addressMapper;

    public VisaCheckoutUpdateActionCreator(PaymentServiceResponseAddressMapper addressMapper) {
