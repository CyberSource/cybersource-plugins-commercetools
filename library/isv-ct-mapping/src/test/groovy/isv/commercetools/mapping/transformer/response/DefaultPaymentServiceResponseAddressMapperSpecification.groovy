...
class DefaultPaymentServiceResponseAddressMapperSpecification extends Specification {

    DefaultPaymentServiceResponseAddressMapper testObj

    def 'setup'() {
        testObj = new DefaultPaymentServiceResponseAddressMapper()
    }
