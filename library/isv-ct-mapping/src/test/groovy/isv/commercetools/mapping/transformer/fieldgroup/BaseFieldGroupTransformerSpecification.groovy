...
class BaseFieldGroupTransformerSpecification extends Specification {
    ...
    def setup() {
        ...
        paymentServiceIds.developerId = 'someDeveloperId'
        testObj = new BaseFieldGroupTransformer(paymentServiceIds)
    }
    ...
    def 'should transform payment to base field group'() {
        ...
        customFieldsMock.getFieldAsString('isv_deviceFingerprintId') >> 'fingerprint id'
