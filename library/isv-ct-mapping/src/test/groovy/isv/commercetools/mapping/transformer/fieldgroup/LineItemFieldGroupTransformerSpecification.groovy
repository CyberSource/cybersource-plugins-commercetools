...
class LineItemFieldGroupTransformerSpecification extends Specification {
    ...
    def 'should transform cart line items with optional custom fields to line item field groups'() {
        ...
        customFieldsMock1.getFieldAsString('isv_productCode') >> 'product code 1'
        customFieldsMock1.getFieldAsString('isv_productRisk') >> 'product risk 1'
        ...
        customFieldsMock2.getFieldAsString('isv_productCode') >> 'product code 2'
        customFieldsMock2.getFieldAsString('isv_productRisk') >> 'product risk 2'
