...
class PayerAuthenticationResponseToActionMapperSpecification extends Specification {
    ...
    def 'should map response for enrolled card'() {
        ...
        then:
        result.size() == 5
        result[0].type.key == 'isv_payments_payer_authentication_enrolment_check'
        ...
        result[1].name == 'isv_payerAuthenticationRequired'
        result[1].value.booleanValue() == true
        result[2].name == 'isv_payerAuthenticationTransactionId'
        result[2].value.textValue() == 'authentication transaction id'
        result[3].name == 'isv_payerAuthenticationAcsUrl'
        result[3].value.textValue() == 'acs url'
        result[4].name == 'isv_payerAuthenticationPaReq'
