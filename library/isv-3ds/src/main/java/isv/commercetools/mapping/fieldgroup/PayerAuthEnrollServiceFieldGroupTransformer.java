package isv.commercetools.mapping.fieldgroup;
...
import isv.payments.model.fields.PayerAuthEnrollServiceFieldGroup;
import java.util.List;

/**
 * Populates PayerAuthEnrollServiceFieldGroup from payment for transaction mode
 */
public final class PayerAuthEnrollServiceFieldGroupTransformer implements
    FieldGroupTransformer<PayerAuthEnrollServiceFieldGroup> {
